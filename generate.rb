...
def get_remote(src, dest = nil)
  dest ||= src
  repo = 'https://raw.github.com/tianlu1677/rails-template/master/files/'
...
remove_gem('sqlite3')
gem 'mysql2'
gem_remote('config_files/database.yml.example')
...
get_remote('config_files/database.yml.example', 'config/database.yml')
...
say 'Applying font-awesome & slim'
